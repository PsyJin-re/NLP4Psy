...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='hide', fig.show='hold'}
  ggplot(result, aes(x=LPR.Q1.U, y=LPR.Q1.I)) +
    ...
    annotate("text", x=-2.2, y=2.4, size=4.5, parse=TRUE,
             label="paste(ICC, ' = .73')") +
...
ggplot(result, aes(x=LPR.Q2.U, y=LPR.Q2.I)) +
    ...
    annotate("text", x=-1.9, y=2.0, size=4.5, parse=TRUE,
             label="paste(ICC, ' = .57')") +
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='hide', fig.show='hold'}
  ggplot(result_12mod, aes(x=LPR.Q1.U, y=LPR.Q1.I)) +
    ...
    annotate("text", x=-2.45, y=1.7, size=4.5, parse=TRUE,
             label="paste(ICC, ' = .79')") +
...
ggplot(result_12mod, aes(x=LPR.Q2.U, y=LPR.Q2.I)) +
    ...
    annotate("text", x=-1.6, y=1.6, size=4.5, parse=TRUE,
             label="paste(ICC, ' = .62')") +
